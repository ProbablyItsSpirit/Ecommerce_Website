...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-Xfjf1sKvkaJMn+brKNOeM3u8ElhDlzkl6n3CC4YmXda6+LoTkwfQwKEnwvXX+IdbQwGXWM8pb0Dr5hVOwFcP8w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body>
    ...
    <div class="sub-navbar">
        ...
        <a href="#" class="sub-navbar-item">Category 1</a>
        <a href="#" class="sub-navbar-item">Category 2</a>
        <a href="#" class="sub-navbar-item">Category 3</a>
